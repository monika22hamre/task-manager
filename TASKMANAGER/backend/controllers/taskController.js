...
const getTasks = async (req, res) => {
  try {
    ...
    //Add completed totoChecklist count to each task
...
const updateTask = async (req, res) => {
  try {
    ...
    task.description = req.body.description || task.priority;
    task.priority = req.body.priority || task.priority;
    task.dueDate = req.body.deuDate || task.dueDate;
...
const getDashboardData = async (req, res) => {
  try {
    ...
    taskDistribution["All"] = totalTasks; //Add total count to taskDistribytion
...
const getUserDashboardData = async (req, res) => {
  try {
    const userId = req.user._id; //Only tetch data for the logged-in user
